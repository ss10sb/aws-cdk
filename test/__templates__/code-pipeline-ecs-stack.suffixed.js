                ...
                Source: {
                    BuildSpec: {
                        ...
                        '        "npm install -g cdk-assets@latest"\n' +
                                ...
                                '    "build": {\n' +
                                '      "commands": [\n' +
                        '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-prod-test-abc-stage/pccsharedtestpccprodtestabcstagepccprodtestabc9A6B29AB.assets.json\\" --verbose publish \\"34a66902956b031404ef497526f619b900363fe7fd65ff02b1de4c30fe10c034:11111-us-west-2-8f0e137f\\"",\n' +
                        '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-prod-test-def-stage/pccsharedtestpccprodtestdefstagepccprodtestdef27A5C606.assets.json\\" --verbose publish \\"34a66902956b031404ef497526f619b900363fe7fd65ff02b1de4c30fe10c034:22222-us-west-2-72189ee5\\""\n' +
                                '      ]\n' +
                                '    }\n' +
                                '  }\n' +
                                '}'
                  ...
                  'Fn::Join': [
                    ...
                    [
                      ...
                      `\\":{\\"ecrRepository\\":true}}}' > $HOME/.cdk/cdk-docker-creds.json"\n` +
                        ...
                        '    "build": {\n' +
                        '      "commands": [\n' +
                        '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-prod-test-abc-stage/pccsharedtestpccprodtestabcstagepccprodtestabc9A6B29AB.assets.json\\" --verbose publish \\"2819175352ad1ce0dae768e83fc328fb70fb5f10b4a8ff0ccbcb791f02b0716d:11111-us-west-2-eb2c19cf\\"",\n' +
                        '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-prod-test-def-stage/pccsharedtestpccprodtestdefstagepccprodtestdef27A5C606.assets.json\\" --verbose publish \\"2819175352ad1ce0dae768e83fc328fb70fb5f10b4a8ff0ccbcb791f02b0716d:22222-us-west-2-6ba12b5f\\""\n' +
                        '      ]\n' +
                        '    }\n' +
                        '  }\n' +
                        '}'
                ...
                Source: {
                    BuildSpec: {
                        ...
                        '        "npm install -g cdk-assets@latest"\n' +
                                ...
                                '    "build": {\n' +
                                '      "commands": [\n' +
                        '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-prod-test-abc-stage/pccsharedtestpccprodtestabcstagepccprodtestabc9A6B29AB.assets.json\\" --verbose publish \\"52c9314b13b741507475c767efe12405a840f6378675be91df8d62589aa0f401:11111-us-west-2-8a100768\\""\n' +
                                '      ]\n' +
                                '    }\n' +
                                '  }\n' +
                                '}'
