              ...
              Description: 'Pipeline step pcc-shared-test/Pipeline/Assets/AWS679f53fac002430cb0da5b7982bd2287_Code',
                ...
                Source: {
                  ...
                  '        "npm install -g cdk-assets@latest"\n' +
                        ...
                        '    "build": {\n' +
                        '      "commands": [\n' +
                  '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-sdlc-test-stage/pccsharedtestpccsdlcteststagepccsdlctest0A9A7A91.assets.json\\" --verbose publish \\"9d043014be736e8162bcc7ec5590cc6d2ff24fd0d9c73a5c5d595151c5fdad00:11111-us-west-2\\"",\n' +
                  '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-prod-test-stage/pccsharedtestpccprodteststagepccprodtest180889E6.assets.json\\" --verbose publish \\"9d043014be736e8162bcc7ec5590cc6d2ff24fd0d9c73a5c5d595151c5fdad00:22222-us-west-2\\""\n' +
                        '      ]\n' +
                        '    }\n' +
                        '  }\n' +
                        '}',
              ...
              Description: 'Pipeline step pcc-shared-test/Pipeline/Assets/pcc-sdlc-test-event-fn-0_Code',
                ...
                Source: {
                  ...
                  '        "npm install -g cdk-assets@latest"\n' +
                        ...
                        '    "build": {\n' +
                        '      "commands": [\n' +
                  '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-sdlc-test-stage/pccsharedtestpccsdlcteststagepccsdlctest0A9A7A91.assets.json\\" --verbose publish \\"069f9cad9bb99e307ac25e484fed42e132ea239d278f73d73c599b9965c7b12f:11111-us-west-2\\"",\n' +
                  '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-prod-test-stage/pccsharedtestpccprodteststagepccprodtest180889E6.assets.json\\" --verbose publish \\"069f9cad9bb99e307ac25e484fed42e132ea239d278f73d73c599b9965c7b12f:22222-us-west-2\\""\n' +
                        '      ]\n' +
                        '    }\n' +
                        '  }\n' +
                        '}',
              ...
              Description: 'Pipeline step pcc-shared-test/Pipeline/Assets/s3-assets-copy_AwsCliLayer_Code',
                ...
                Source: {
                  ...
                  '        "npm install -g cdk-assets@latest"\n' +
                        ...
                        '    "build": {\n' +
                        '      "commands": [\n' +
                  '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-sdlc-test-stage/pccsharedtestpccsdlcteststagepccsdlctest0A9A7A91.assets.json\\" --verbose publish \\"a912487bb1b34f5e5f6f07325f76f44d9faf30d9054d221303f1f3220d1d610e:11111-us-west-2\\"",\n' +
                  '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-prod-test-stage/pccsharedtestpccprodteststagepccprodtest180889E6.assets.json\\" --verbose publish \\"a912487bb1b34f5e5f6f07325f76f44d9faf30d9054d221303f1f3220d1d610e:22222-us-west-2\\""\n' +
                        '      ]\n' +
                        '    }\n' +
                        '  }\n' +
                        '}',
              ...
              Description: 'Pipeline step pcc-shared-test/Pipeline/Assets/Custom_CDKBucketDeployment8693BB64968944B69AAFB0CC9EB8756C_Code',
                ...
                Source: {
                  ...
                  '        "npm install -g cdk-assets@latest"\n' +
                        ...
                        '    "build": {\n' +
                        '      "commands": [\n' +
                  '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-sdlc-test-stage/pccsharedtestpccsdlcteststagepccsdlctest0A9A7A91.assets.json\\" --verbose publish \\"9a1fcb4a7ecba81ad70e9d3fb241f6794497da945dae5f25924e4dd002b65f2d:11111-us-west-2\\"",\n' +
                  '        "cdk-assets --path \\"assembly-pcc-shared-test-pcc-prod-test-stage/pccsharedtestpccprodteststagepccprodtest180889E6.assets.json\\" --verbose publish \\"9a1fcb4a7ecba81ad70e9d3fb241f6794497da945dae5f25924e4dd002b65f2d:22222-us-west-2\\""\n' +
                        '      ]\n' +
                        '    }\n' +
                        '  }\n' +
                        '}',
